...
const en = {
  ...
  escalate: {
    ...
    raiseLead: "Your case has passed a deadline. You can put that on the record and send it to a higher authority, who will see it named, dated and timed.",
    goesTo: "This goes to",
    windowNote: "You have {days} days to raise it at this level.",
    ...
    doneBody: "It is on the case record, with the date and the authority it went to. Nobody can say it was not raised.",
    alreadyRaised: "Raised on {date} to {authority}.",
...
const hi: Messages = {
  ...
  escalate: {
    ...
    raiseLead: "आपका केस एक समय-सीमा पार कर चुका है। आप इसे रिकॉर्ड पर ला सकते हैं और उच्च अधिकारी तक भेज सकते हैं, जहाँ यह नाम, तारीख और समय के साथ दर्ज रहेगा।",
    goesTo: "यह इनके पास जाएगा",
    windowNote: "इस स्तर पर दर्ज कराने के लिए आपके पास {days} दिन हैं।",
    ...
    doneBody: "यह केस रिकॉर्ड में तारीख और संबंधित प्राधिकारी के साथ दर्ज है। अब कोई नहीं कह सकता कि यह उठाई ही नहीं गई।",
    alreadyRaised: "{date} को {authority} के पास दर्ज।",
